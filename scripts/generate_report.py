...
<head>
    ...
    <link rel="icon" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><circle cx='16' cy='16' r='12' fill='none' stroke='%23c084fc' stroke-width='4' stroke-dasharray='56.5 75.4' stroke-linecap='round' transform='rotate(-90 16 16)'/></svg>">
